...
const Home = ({title}: {title:string}) => {
    return (
        <>
            ...
            <main id="home">
                <div id="homeCarousel" className="carousel slide" data-bs-ride="carousel" data-bs-interval="10000">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active slide-one">
                            <div className="carousel-item-contents row">
                                <div className="caption col-12">
                                    ...
                                    <h1 className="caption-header">Halo, <br />
                                ...
                                <div className="img col-12">
                                    <picture>
                                        <source media="(min-width:1200px)" srcSet="/img/home/img-1-desktop.png" />
                        ...
                        <div className="carousel-item slide-two">
                            <div className="carousel-item-contents row">
                                <div className="caption col-12">
                                    ...
                                    <p className="text-one">
                                        Banyak fitur dan penawaran hebat.</p>
                                    <p className="text-one">Lihat apa yang dapat Anda <br />
                                        lakukan dengan design CAKA.
                                    </p>
                                </div>
                                <div className="img col-12">
                                    <picture>
                                        <source media="(min-width:1200px)" srcSet="/img/home/img-2-desktop.png" />
                        ...
                        <div className="carousel-item slide-three">
                            <div className="carousel-item-contents row">
                                ...
                                <div className="img col-12">
                                    <picture>
                                        <source media="(min-width:1200px)" srcSet="/img/home/img-3-desktop.png" />
